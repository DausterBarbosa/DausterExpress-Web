...
interface InformationModalProps {
    ...
    data: RecipientProps | undefined
}

const RecipientInformationModal:React.FC<InformationModalProps> = ({open, setOpen, data}) => {
    return (
        <Modal open={open} onClose={() => setOpen(false)} sx={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
            <OrdersPageModalContainer>
                <Typography><span style={{fontWeight:"bold", fontSize: "15px", color: "#61605f"}}>NOME:</span> {data?.nome}</Typography>
                ...
                <Typography><span style={{fontWeight:"bold", fontSize: "15px", color: "#61605f"}}>CNPJ:</span> {data?.cnpj}</Typography>
                ...
                <Typography><span style={{fontWeight:"bold", fontSize: "15px", color: "#61605f"}}>COMPLEMENTO:</span> {data?.complemento}</Typography>
...
export default RecipientInformationModal;